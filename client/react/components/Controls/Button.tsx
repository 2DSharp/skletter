...
interface MapLayout {
    [key: string]: React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>;
}
...
class Button extends React.Component<ButtonProps, {}> {
    render() {
        let btnMap: MapLayout = {
            action: (
                <button className={this.props.bindClass} onClick={this.props.action}>
                    {this.props.children}
                </button>
            ),
            close: (
                <button onClick={this.props.action} className="close-button">
                    <svg
